...
export class Row extends Component {
    ...
    unlockLine() {
        if(GameManager.getInstance().money < 100) return;
    ...
    toBoat(parent: Node) {
        ...
        tween(firstChild)
            .to(distance1 / 1600, { worldPosition: this.p1.worldPosition })
            .to(distance2 / 1600, { worldPosition: p2 })
            .to(distance3 / 1600, { worldPosition: parent.worldPosition })
            .start();
