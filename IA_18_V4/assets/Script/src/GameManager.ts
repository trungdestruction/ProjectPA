import { _decorator, Component, instantiate, Label, Node, Prefab, tween, Vec2, Vec3 } from 'cc';
...
export class GameManager extends Component {
    ...
    spawnVfxBoom() {
        let boom = instantiate(this.vfxBoom);
        boom.parent = this.node;
        let x = this.randomInt(-100, 100);
        let y = this.randomInt(850, 950);
        boom.position = new Vec3(x, y, 0);
        this.scheduleOnce(() => {
            boom.destroy();
        }, 0.65);
    }
